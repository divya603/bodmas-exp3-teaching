...
⚠️ Stems on the exact observed values, not KDEs. The marginals here take seven
distinct values in total (1.000 plus six between 0.556 and 0.857); a Gaussian
KDE would invent a smooth density where the data is a handful of spikes.
